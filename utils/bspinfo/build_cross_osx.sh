...
powerpc-apple-darwin9-strip -S bspinfo || exit 1
mv bspinfo bspinfo.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S bspinfo || exit 1
mv bspinfo bspinfo.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S bspinfo || exit 1
mv bspinfo bspinfo.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o bspinfo.bin bspinfo.ppc bspinfo.x86 bspinfo.x86_64 || exit 1
