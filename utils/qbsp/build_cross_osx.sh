...
powerpc-apple-darwin9-strip -S qbsp || exit 1
mv qbsp qbsp.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S qbsp || exit 1
mv qbsp qbsp.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S qbsp || exit 1
mv qbsp qbsp.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o qbsp.bin qbsp.ppc qbsp.x86 qbsp.x86_64 || exit 1
