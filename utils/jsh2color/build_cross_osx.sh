...
powerpc-apple-darwin9-strip -S jsh2colour || exit 1
mv jsh2colour jsh2colour.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S jsh2colour || exit 1
mv jsh2colour jsh2colour.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S jsh2colour || exit 1
mv jsh2colour jsh2colour.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o jsh2colour.bin jsh2colour.ppc jsh2colour.x86 jsh2colour.x86_64 || exit 1
