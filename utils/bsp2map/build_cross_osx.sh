...
powerpc-apple-darwin9-strip -S bsp2map || exit 1
mv bsp2map bsp2map.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S bsp2map || exit 1
mv bsp2map bsp2map.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S bsp2map || exit 1
mv bsp2map bsp2map.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o bsp2map.bin bsp2map.ppc bsp2map.x86 bsp2map.x86_64 || exit 1
