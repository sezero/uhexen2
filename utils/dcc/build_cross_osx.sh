...
powerpc-apple-darwin9-strip -S dhcc || exit 1
mv dhcc dhcc.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S dhcc || exit 1
mv dhcc dhcc.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S dhcc || exit 1
mv dhcc dhcc.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o dhcc.bin dhcc.ppc dhcc.x86 dhcc.x86_64 || exit 1
