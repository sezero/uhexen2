...
*/
  ...
  {"/=", "DIV_E_FF", 5, true, &def_float, &def_float, &def_float},  //70
  {"/=", "DIVP_E_FF", 5, true, &def_pointer, &def_float, &def_float},
  {"+=", "ADD_E_FF", 5, true, &def_float, &def_float, &def_float}, //ok
  {"+=", "ADD_E_VV", 5, true, &def_vector, &def_vector, &def_vector},//ok
  {"+=", "ADDP_E_FF", 5, true, &def_pointer, &def_float, &def_float},  //74 ok
  ...
  {"-=", "SUBP_E_FF", 5, true, &def_pointer, &def_float, &def_float},   //ok
  {"-=", "SUBP_E_VV", 5, true, &def_pointer, &def_vector, &def_vector},  //79
  {"->", "ADDRESS", 3, false, &def_float, &def_float, &def_float},
  {"->", "ADDRESS", 3, false, &def_vector, &def_float, &def_vector},  //81
  {"<UNKNOWN>", "<UNKNOWN>", 5, true, &def_void, &def_void, &def_void},
  {"<UNKNOWN>", "<UNKNOWN>", 5, true, &def_void, &def_void, &def_void},
  {"<UNKNOWN>", "<UNKNOWN>", 3, true, &def_void, &def_void, &def_void},  //84
  {"<SETFRAME>", "SET_FRAME", -1, false, &def_float, &def_float, &def_float},  //85
  {"<UNKNOWN>", "<UNKNOWN>", 3, true, &def_pointer, &def_float, &def_float},
  {"<SETTHINK>", "SET_THINKTIME", -1, false, &def_entity, &def_float, &def_void},  //87
  {"|=", "BITOR_E_FF", 5, true, &def_float, &def_float, &def_float},
  {"|=", "BITORP_E_FF", 5, true, &def_pointer, &def_float, &def_float},    //89
  {"^=", "XOR_E_FF", 5, true, &def_float, &def_float, &def_float},    //90 I think this is right???
  {"^=", "XORP_E_FF", 5, true, &def_pointer, &def_float, &def_float},    //91
