...
#ifndef _WIN32_WCE
#ifdef __WATCOMC__
/* OpenWatcom has _beginthread() and _endthread() defined in process.h */
#include <process.h>
#else
/* GCC has _beginthread() and _endthread() defined in stdlib.h */
#include <stdlib.h>  /* This has _beginthread() and _endthread() defined! */
#endif
#endif
