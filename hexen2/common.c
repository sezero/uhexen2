/*
	...
	$Id: common.c,v 1.76 2006-09-16 15:29:09 sezero Exp $
*/
 ...
 * Revision 1.75  2006/09/16 13:18:11  sezero
 * whitespace clean-up before I do the actual changes
 *
 * Revision 1.74  2006/09/15 09:48:35  sezero
 * made COM_DefaultExtension to check the size of its path
 * argument and error out if truncation occurs.
 *
 ...
 *
 * Revision 1.65  2006/06/24 16:04:35  sezero
 ...
 *
 * Revision 1.59  2006/05/18 17:46:10  sezero
 ...
 *
 * Revision 1.47  2006/03/25 19:12:02  sezero
 * added a simple COM_FileInGamedir() which reports the existance of
 * a file with read permissions in com_gamedir or com_userdir. -1 is
 * returned on failure, ie the return value of the access() function
 *
 * Revision 1.46  2006/03/25 14:49:59  sezero
 * Change the *gamedir serverinfo key properly in COM_Gamedir(), not
 * in SV_Gamedir_f(), so that it is properly set when the server is
 * started by a -game argument.
 *
 ...
 *
 * Revision 1.43  2006/03/25 10:26:28  sezero
