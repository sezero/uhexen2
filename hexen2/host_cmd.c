/*
	...
	$Header: /home/ozzie/Download/0000/uhexen2/hexen2/host_cmd.c,v 1.72 2007-04-01 12:18:18 sezero Exp $
*/
...
static void Host_Create_f (void)
{
	...
	if (!func)
	{
		...
		if (NumFound != 1)
		{
			snprintf(key_lines[edit_line], MAXCMDLINE, ">create %s", PR_GetString(func->s_name));
