 ...
 * Art update
 * 
 * 21    6/01/98 2:49a Mgummelt
 * 
 * 20    5/27/98 6:08p Mgummelt
 * 
 * 19    5/25/98 10:56p Mgummelt
 * Last version before send-off, v0.15
 * 
 * 18    5/25/98 8:38p Mgummelt
 * 
 ...
 * 
 * 14    5/05/98 8:33p Mgummelt
 * Added 6th playerclass for Siege only- Dwarf
 * 
 * 13    4/27/98 6:54p Mgummelt
 * 
 * 12    4/24/98 1:31a Mgummelt
 * Siege version 0.02 4/24/98 1:31 AM
 * 
 * 11    4/23/98 5:19p Mgummelt
 * Siege version 0.01 4/23/98
 * 
 * 10    4/17/98 9:00p Mgummelt
 ...
 * New longbow and sickle weapon models
 * 
