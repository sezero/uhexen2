 ...
 * 
 * 28    5/27/98 6:08p Mgummelt
 * 
 * 27    5/25/98 10:56p Mgummelt
 * Last version before send-off, v0.15
 * 
 * 26    5/25/98 8:38p Mgummelt
 * 
 * 25    5/25/98 1:39p Mgummelt
 * 
 * 24    5/25/98 1:31p Mgummelt
 * 
 * 23    5/08/98 1:18p Mgummelt
 * 
 * 22    5/07/98 11:19p Mgummelt
 * Almost ready for release- fix some dwarf-related compatibility problems
 * 
 * 21    5/05/98 8:33p Mgummelt
 * Added 6th playerclass for Siege only- Dwarf
 * 
 * 20    5/01/98 4:02p Mgummelt
 * Siege version 0.2 5/1/98 4:02PM
 * 
 * 19    4/30/98 6:01p Mgummelt
 * 
 * 18    4/30/98 10:21a Mgummelt
 * Siege version 0.1 4/30/98
 * 
 * 17    4/27/98 6:54p Mgummelt
 * 
 * 16    4/27/98 4:34p Mgummelt
 * Siege beta version 0.13
 * 
 * 15    4/24/98 1:31a Mgummelt
 * Siege version 0.02 4/24/98 1:31 AM
 * 
 * 14    4/23/98 5:19p Mgummelt
 * Siege version 0.01 4/23/98
 * 
 * 13    4/17/98 9:00p Mgummelt
