...
powerpc-apple-darwin9-strip -S hwmaster || exit 1
mv hwmaster hwmaster.ppc || exit 1
$MAKE_CMD distclean
...
i686-apple-darwin9-strip -S hwmaster || exit 1
mv hwmaster hwmaster.x86 || exit 1
$MAKE_CMD distclean
...
x86_64-apple-darwin9-strip -S hwmaster || exit 1
mv hwmaster hwmaster.x86_64 || exit 1
$MAKE_CMD distclean

$LIPO -create -o hwmaster.bin hwmaster.ppc hwmaster.x86 hwmaster.x86_64 || exit 1
